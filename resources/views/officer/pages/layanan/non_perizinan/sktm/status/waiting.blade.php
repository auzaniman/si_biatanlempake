      ...
      <div class="card-body p-3">
        <div class="row gx-4">
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mb-1">
                Data Pemohon Surat Keterangan Tidak Mampu dalam proses
              </h5>
            </div>
          </div>
        </div>
              ...
              @forelse ($sktm as $item)
                <tr>
                  ...
                  <td class="align-middle text-center">
                    <a href="{{route('officer.show_sktm', $item->id)}}" class="btn btn-xs btn-success text-xs mb-0" data-toggle="tooltip" data-original-title="Edit user">
                      Verifikasi
                    </a>
                  </td>
                </tr>
