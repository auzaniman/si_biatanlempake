      ...
      <div class="card-body p-3">
        <div class="row gx-4">
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mb-1">
                Data Pemohon Surat Pengantar Desa
              </h5>
            </div>
          </div>
        </div>
            ...
            <tbody>
              @forelse ($supengdesa as $item)
                <tr>
                  ...
                  <td class="align-middle">
                    <a href="{{route('officer.show_supengdesa', $item->id)}}" class="btn btn-xs btn-warning text-xs mb-0" data-toggle="tooltip" data-original-title="Edit user">
                      Verifikasi
                    </a>
                  </td>
                  @endif
