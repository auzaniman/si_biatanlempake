          ...
          <li class="list-group-item border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
              ...
              <table class="table align-items-center mb-3 table-borderless">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span class="text-dark ms-sm-2 font-weight-bold">:  {{$supengdesa->nik_pemohon}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="ps-0">
                    ...
                    <td>
                      <span class="text-dark ms-sm-2 font-weight-bold">:  {{$supengdesa->kk_pemohon}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="ps-0">
                    ...
                    <td>
                      <span class="text-dark ms-sm-2 font-weight-bold">:  {{$supengdesa->alamat_pemohon}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="ps-0">
                    ...
                    <td>
                      <span class="text-dark ms-sm-2 font-weight-bold">:  {{$supengdesa->email_pemohon}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="ps-0">
                    ...
                    <td>
                      <span class="text-dark ms-sm-2 font-weight-bold">:  {{$supengdesa->hp_pemohon}}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div class="ms-auto text-end mb-3">
              <form action="{{route('officer.update_alt_supengdesa', $supengdesa->id)}}" method="POST" enctype="multipart/form-data">
                ...
                @csrf
                <div class="d-flex">
                  <input name="file_permohonan_supengdesa" id="file_permohonan_supengdesa" class="form-control me-3" type="file" value="">
                  <button type="submit" class="btn btn-success mb-0">
                    Upload
                  </button>
                </div>
