      ...
      <div class="card-body p-3">
        <div class="row gx-4">
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mb-1">
                Data Pemohon Surat Domisili Yang Ditolak
              </h5>
            </div>
          </div>
        </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <button class="btn btn-icon btn-xs btn-3 btn-warning me-2" type="button">
          ...
          <a href="{{route('officer.waiting_surdom')}}" class="btn-inner--text text-decoration-none text-reset">Waiting</a>
        </button>
        <button class="btn btn-icon btn-xs btn-3 btn-success" type="button">
          <span class="btn-inner--icon"><i class="fa fa-check-circle"></i></span>
          <a href="{{route('officer.terverifikasi_surdom')}}" class="btn-inner--text text-decoration-none text-reset">Terverifikasi</a>
        </button>
              ...
              @forelse ($surdom as $item)
                <tr>
                  ...
                  <td class="align-middle text-center">
                    <a href="{{route('officer.show_surdom', $item->id)}}" class="btn btn-xs btn-primary text-xs mb-0" data-toggle="tooltip" data-original-title="Edit user">
                    Detail
                    </a>
                  </td>
                </tr>
