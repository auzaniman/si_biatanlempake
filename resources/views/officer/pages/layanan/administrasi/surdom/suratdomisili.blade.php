    ...
    <div class="card">
      <div class="card-body">
        ...
        <button class="btn btn-icon btn-xs btn-3 btn-danger" type="button">
          ...
          <a href="{{route('officer.ditolak_surdom')}}" class="btn-inner--text text-decoration-none text-reset">Ditolak</a>
        </button>
...
<a href="{{route('officer.administrasi')}}" class="btn btn-warning btn-icon mt-3">
