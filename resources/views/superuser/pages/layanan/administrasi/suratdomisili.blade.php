      ...
      <div class="card-body">
        ...
        <form method="POST" action="{{route('post_surdom')}}" enctype="multipart/form-data">
          ...
          <div class="row" hidden>
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input name="nama_ajuan" id="nama_ajuan" class="form-control disabled" type="text" value="Surat Domisili">
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="d-flex align-items-center mt-3">
            <a href="{{route('administrasi')}}" class="btn btn-sm btn-warning btn-icon">
